...
(function($) {
	/**
	 * jqGrid Spanish Translation Traduccion jqGrid en Espa̱ol por Yamil Bracho
	 * Traduccion corregida y ampliada por Faserline, S.L.
	 * http://www.faserline.com Dual licensed under the MIT and GPL licenses:
	...
	$.extend($.jgrid, {
		...
		search : {
			...
			Reset : "Limpiar",
			odata : [
					'igual ', 'no igual a', 'menor que', 'menor o igual que', 'mayor que', 'mayor o igual a', 'empiece por', 'no empiece por', 'est&aacute; en', 'no est&aacute; en', 'termina por', 'no termina por', 'contiene', 'no contiene'
			],
			groupOps : [
					{
						op : "AND",
		...
		edit : {
			...
			msg : {
				...
				email : "no es una direcci&oacute;n de correo v&acute;lida",
		...
		formatter : {
			...
			date : {
				dayNames : [
						"Do", "Lu", "Ma", "Mi", "Ju", "Vi", "Sa", "Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado"
				],
				monthNames : [

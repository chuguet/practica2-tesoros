...
class HitoDispositivoService implements IHitoDispositivoService {
	...
	public List<HitoDispositivo> selectByCriterios(Integer id_hito, Integer id_dispositivo, String longitud, String latitud, Integer identificado, Date fecha, Integer id_ruta) throws AppException {
		...
		criterios.setId_ruta(id_ruta);
		try {
			return hitoDispositivoDAO.selectByCriterios(criterios);
		}
		catch (SQLException e) {
			throw new AppException("Se ha producido un error al buscar hitos chequeados por criterios");
		}
	}
}
